DESAFIO INDIVIDUAL - Processo Seleteivo 2023.2
---------------------------------------------------
CEOS Counter - A counter for CEOS

A opção escolhida foi Frontend. Consiste em:
- Um contador que mostra o valor atualizado e tem padrão como 0
- Um botão '+' que incrementa o contador
- Um botão '-' que decrementa o contador
- Um componente MostrarValor, que recebe uma string como prop e exibe centralizada vertical e horizontalmente dentro do limite de 100px x 100px
